import { Menu, X, Home, User, CreditCard, History, Settings, PhoneCall, Shield, LogOut, Bell } from "lucide-react";
              ...
              <div className="bg-gradient-to-r from-red-600 to-red-700 p-6">
                <div className="flex items-center justify-between mb-6">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <h2 className="text-xl font-bold text-white">Call<span className="text-white">Bell</span></h2>
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-white/80 text-sm truncate">{user?.email || "user@example.com"}</p>
                    </div>
                  </div>
                </div>
              </div>
                      ...
                      <div key={link.href} className="relative">
                        ...
                        >
                          <link.icon className={`w-5 h-5 mr-3 ${
                            isActive ? 'text-red-600' : 'text-gray-500 group-hover:text-red-600'
                          }`} />
      ...
      <div className="flex-none">
        <div className="flex items-center space-x-4">
          ...
          <div className="text-right">
            <h2 className="font-bold text-gray-900 text-lg">Call<span className="text-red-600">Bell</span></h2>
